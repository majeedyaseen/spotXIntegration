...
@interface SPOTXMoatOptions : NSObject<NSCopying>
...
@interface SPOTXMoatAnalytics : NSObject
 ...
 * @see SPOTXMoatOptions
 */
- (void)startWithOptions:(SPOTXMoatOptions *)options;
 ...
 * @see SPOTXMoatVideoTracker.h for more detail on what constitues a native ad.
 *
