...
#import "SPOTXMoatAdEvent.h"
#import "SPOTXMoatBaseTracker.h"

typedef enum SPOTXMoatTrackerState : NSUInteger {
    MTStateUninitialized
    , MTStateInitialized
    , MTStateTracking
    , MTStateDestroyed
} SPOTXMoatTrackerState;
 ...
 *
 */
@interface SPOTXMoatReactiveVideoTracker : SPOTXMoatBaseTracker

@property (readonly) SPOTXMoatTrackerState state;
 ...
 * @return SPOTXMoatReactiveVideoTracker instance
 */
+ (SPOTXMoatReactiveVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
 ...
 *
 * @see SPOTXMoatAdEvent to see the required video ad events that must be reported to the SDK if they occur
 */
- (void)dispatchEvent:(SPOTXMoatAdEvent *)event;
