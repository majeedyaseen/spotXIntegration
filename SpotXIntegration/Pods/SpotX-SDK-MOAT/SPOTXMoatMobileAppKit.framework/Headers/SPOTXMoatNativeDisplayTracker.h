 ...
 */
@interface SPOTXMoatNativeDisplayTracker : SPOTXMoatBaseTracker
 ...
 * @return SPOTXMoatNativeDisplayTracker instance
 */
+ (SPOTXMoatNativeDisplayTracker *)trackerWithAdView:(UIView *)adView withAdIds:(NSDictionary *)adIds;
